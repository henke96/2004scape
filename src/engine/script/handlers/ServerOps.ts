...
const ServerOps: CommandHandlers = {
    ...
    [ScriptOpcode.PROJANIM_PL]: state => {
        ...
        World.mapProjAnim(srcPos.level, srcPos.x, srcPos.z, activePlayer.x, activePlayer.z, -activePlayer.pid - 1, spotanimType.id, srcHeight + 100, dstHeight + 100, delay, duration, peak, arc);
    },
    ...
    [ScriptOpcode.PROJANIM_NPC]: state => {
        ...
        World.mapProjAnim(srcPos.level, srcPos.x, srcPos.z, activeNpc.x, activeNpc.z, activeNpc.nid + 1, spotanimType.id, srcHeight + 100, dstHeight + 100, delay, duration, peak, arc);
    },
